                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdown02">
                                <li><a class="dropdown-item" href="{{ asset('/appointmentList') }}">Appointment</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ asset('/doctor') }}">Booking Appointment</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdown03">
                                <li><a class="dropdown-item" href="{{ asset('/viewPrescriptions') }}">Prescription
                                        List</a></li>
                            </ul>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{ asset('/logout') }}">Logout</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <form id="#" class="appoinment-form" method="post" action="#">
                <div class="row justify-content-center">
                    ...
                    <a class="btn btn-main btn-round-full" href="{{ asset('/editProfile') }}">Update Profile<i class="icofont-simple-right ml-2"></i></a><br><br>
