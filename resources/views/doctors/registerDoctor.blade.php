        ...
        <form action="{{route('register-doctor')}}" method="post">
          ...
          <form>
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Enter Full Name" name="doctorname" value="{{old('doctorname')}}">
              <span class="text-danger">@error('doctorname') {{$message}} @enderror</span>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Enter Speciality" name="speciality" value="{{old('speciality')}}">
